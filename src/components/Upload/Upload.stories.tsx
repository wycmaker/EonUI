  ...
  return (
    <div className="component-docs-container">
      ...
      <div className="component-docs-section">
        ...
        <p className="component-docs-section-description">
          Upload 組件支援多種使用方式，從簡單的按鈕到完整的拖拽區域：
        </p>
        ...
        <div className="component-docs-showcase">
          <div className="space-y-6">
            {/* 預設樣式上傳 */}
            <div>
              <h4 className="font-medium mb-3 text-gray-600">預設樣式上傳</h4>
              <Upload
                multiple
                accept=".pdf,.doc,.docx"
              />
            ...
            {/* 拖拽上傳 */}
            <div>
              <h4 className="font-medium mb-3 text-gray-600">拖拽上傳</h4>
              <Upload
                dragger
                multiple
                accept="image/*"
      ...
      {/* 顯示模式 */}
      <div className="component-docs-section">
        <h2 className="component-docs-section-title">🖼️ 顯示模式</h2>
        <p className="component-docs-section-description">支援三種不同的檔案列表顯示模式：</p>
      ...
      <div className="component-docs-section">
        ...
        <p className="component-docs-section-description">Upload 組件提供了三種不同的樣式變體：</p>
      ...
      {/* 進階功能 */}
      <div className="component-docs-section">
        <h2 className="component-docs-section-title">⚡ 進階功能</h2>
        <p className="component-docs-section-description">
          Upload 組件支援多項進階功能，提供完整的檔案上傳體驗：
        </p>
      ...
      {/* 事件處理 */}
      <div className="component-docs-section">
        <h2 className="component-docs-section-title">🔄 事件處理</h2>
        <p className="component-docs-section-description">
          Upload 組件提供豐富的事件回調，方便進行自訂處理：
        </p>
      ...
      {/* 自訂上傳 */}
      <div className="component-docs-section">
        <h2 className="component-docs-section-title">🔧 自訂上傳</h2>
        <p className="component-docs-section-description">支援自訂上傳邏輯，可整合任何上傳服務：</p>
      ...
      <div className="component-docs-section">
        ...
        <p className="component-docs-section-description">
          Upload 組件遵循 WCAG 2.1 AA 標準，提供完整的無障礙性支援：
        </p>
