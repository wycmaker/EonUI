...
const BlogLayout = ({ children }) => (
  <Layout
    ...
    fullHeight={true}
  />
);`})]})]}),e.jsxs("div",{className:"component-docs-cta",children:[e.jsx("h3",{className:"component-docs-cta-title",children:"🏗️ 開始使用"}),e.jsx("p",{className:"component-docs-cta-text",children:"現在你已經了解了 Layout 組件的所有功能，可以在你的項目中開始使用了！ 這個靈活的佈局系統可以幫助你快速建立各種頁面結構，從簡單的內容頁面到複雜的管理後台。"})]})]}),A={title:"Components/Layout",component:t,parameters:{layout:"fullscreen",docs:{page:()=>e.jsx(u,{})}},argTypes:{header:{control:{type:"boolean"},description:"頁面標題區域內容",table:{type:{summary:"React.ReactNode"}},mapping:{true:e.jsx(i,{}),false:void 0}},aside:{control:{type:"boolean"},description:"側邊欄內容",table:{type:{summary:"React.ReactNode"}},mapping:{true:e.jsx(r,{}),false:void 0}},footer:{control:{type:"boolean"},description:"頁腳內容",table:{type:{summary:"React.ReactNode"}},mapping:{true:e.jsx(l,{}),false:void 0}},asidePosition:{control:{type:"select"},options:["left","right"],description:"側邊欄位置",table:{type:{summary:"string"},defaultValue:{summary:"left"}}},asideWidth:{control:{type:"select"},options:["sm","md","lg","xl","auto"],description:"側邊欄寬度",table:{type:{summary:"string"},defaultValue:{summary:"md"}}},headerHeight:{control:{type:"select"},options:["sm","md","lg","auto"],description:"標題區域高度",table:{type:{summary:"string"},defaultValue:{summary:"md"}}},footerHeight:{control:{type:"select"},options:["sm","md","lg","auto"],description:"頁腳高度",table:{type:{summary:"string"},defaultValue:{summary:"md"}}},stickyHeader:{control:{type:"boolean"},description:"是否固定標題",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},stickyFooter:{control:{type:"boolean"},description:"是否固定頁腳",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},stickyAside:{control:{type:"boolean"},description:"是否固定側邊欄",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},spacing:{control:{type:"select"},options:[0,1,2,3,4,5,6,8],description:"內容區域間距",table:{type:{summary:"number"},defaultValue:{summary:"0"}}},fullHeight:{control:{type:"boolean"},description:"是否全螢幕高度",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},asideHeight:{control:{type:"select"},options:["full","content"],description:"側邊欄高度模式",table:{type:{summary:"string"},defaultValue:{summary:"content"}}},responsiveAside:{control:{type:"boolean"},description:"響應式側邊欄（在小螢幕上隱藏）",table:{type:{summary:"boolean"},defaultValue:{summary:"true"}}},mobileMenuButtonClassName:{control:{type:"text"},description:"手機版選單按鈕的 CSS 類別，用於自定義樣式",table:{type:{summary:"string"}}}},tags:["autodocs"]},n={args:{header:!0,aside:!0,footer:!0,asidePosition:"left",asideWidth:"md",headerHeight:"md",footerHeight:"md",asideHeight:"content",stickyHeader:!1,stickyFooter:!1,stickyAside:!1,spacing:0,fullHeight:!0,responsiveAside:!0},render:s=>e.jsx("div",{style:{height:"600px"},children:e.jsx(t,{...s,main:e.jsx(a,{content:"互動式範例主要內容"})})})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    header: true,
    aside: true,
    footer: true,
