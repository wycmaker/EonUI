...
import { Input } from 'eonui/Input';`})})]}),o.jsxs("div",{className:"component-docs-cta",children:[o.jsx("h3",{className:"component-docs-cta-title",children:"🚀 開始探索"}),o.jsxs("p",{className:"component-docs-cta-text",children:["點擊左側選單中的 ",o.jsx("strong",{children:"Components → Button"})," 來查看第一個組件的詳細說明和範例！"]})]})]}),d={title:"Introduction",component:n,parameters:{layout:"fullscreen",docs:{page:()=>o.jsx(n,{})}},tags:["autodocs"]},e={};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:"{}",...e.parameters?.docs?.source}}};const l=["Docs"];export{e as Docs,l as __namedExportsOrder,d as default};
