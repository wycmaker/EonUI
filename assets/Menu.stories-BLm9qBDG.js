...
function NextMenu() {
  ...
  render: args => <div className="w-64 h-96 border border-gray-200 rounded-lg overflow-hidden">\r
      <Menu {...args} />\r
    </div>
