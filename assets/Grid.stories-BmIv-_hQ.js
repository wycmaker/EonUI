...
<Grid container spacing={4}>
  ...
  render: args => <Grid {...args}>\r
      <Grid item xs={12} sm={6} md={4}>\r
        <div className="bg-blue-100 border border-blue-300 p-4 text-center h-20 flex items-center justify-center">\r
          欄位 1\r
        </div>\r
      </Grid>\r
      <Grid item xs={12} sm={6} md={4}>\r
        <div className="bg-green-100 border border-green-300 p-4 text-center h-16 flex items-center justify-center">\r
          欄位 2\r
        </div>\r
      </Grid>\r
      <Grid item xs={12} sm={6} md={4}>\r
        <div className="bg-purple-100 border border-purple-300 p-4 text-center h-24 flex items-center justify-center">\r
          欄位 3\r
        </div>\r
      </Grid>\r
    </Grid>
