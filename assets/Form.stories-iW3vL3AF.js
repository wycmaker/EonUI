import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as i}from"./iframe-lqGEyVtj.js";import{P as K,C as Z}from"./blocks-Cq-kwBFv.js";import{C as S}from"./CodeExample-Dp8PQKs1.js";import{c as D}from"./cn-Dtjc6EhN.js";/* empty css                       */import{I as t}from"./Input-BqeiiyMQ.js";import{S as z}from"./Select-DozYrCCT.js";import{a as O,C as b}from"./Checkbox-9sbZhLf6.js";import{R as W,a as C}from"./Radio-BokAFtSY.js";import{T as G}from"./Textarea-sGCPiHo8.js";import{B as w}from"./Button-CeHKvE-s.js";import{T as H,a as $}from"./Table-5VXUtDan.js";import"./preload-helper-Ll21cQ8F.js";import"./index-3aTa7jhJ.js";import"./clearable-C08SD5GV.js";import"./icons-B4aNx7RA.js";import"./formStyles-D_LMpAhg.js";import"./useClickOutside-CrAsg0FH.js";import"./usePortal-CWC9Fu4s.js";const T=i.createContext(null),P=()=>{const r=i.useContext(T);if(!r)throw new Error("useFormContext must be used within a Form component");return r};try{T.displayName="FormContext",T.__docgenInfo={description:`Form Context
...
${JSON.stringify(r,null,2)}`)}}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  render: args => <div className="max-w-md">\r
      <Form {...args}>\r
        <FormItem name="username" label="使用者名稱" required rules={[Rules.required('使用者名稱為必填'), Rules.minLength(2, '至少需要2個字元')]}>\r
          <Input placeholder="請輸入使用者名稱" />\r
        </FormItem>\r
\r
        <FormItem name="email" label="電子郵件" rules={[Rules.email('請輸入正確的電子郵件格式')]}>\r
          <Input type="email" placeholder="請輸入電子郵件" />\r
        </FormItem>\r
\r
        <FormItem name="gender" label="性別" required rules={[Rules.required('請選擇性別')]}>\r
          <Select options={[{
          value: 'male',
          label: '男性'
        }, {
...
\r
        <FormItem name="hobbies" label="興趣愛好">\r
          <CheckboxGroup>\r
            <Checkbox value="reading">閱讀</Checkbox>\r
            <Checkbox value="music">音樂</Checkbox>\r
            <Checkbox value="sports">運動</Checkbox>\r
          </CheckboxGroup>\r
        </FormItem>\r
\r
        <FormItem name="contactMethod" label="聯絡方式" required rules={[Rules.required('請選擇聯絡方式')]}>\r
          <RadioGroup>\r
            <Radio value="email">電子郵件</Radio>\r
            <Radio value="phone">電話</Radio>\r
            <Radio value="sms">簡訊</Radio>\r
          </RadioGroup>\r
        </FormItem>\r
\r
        <FormItem name="message" label="留言" rules={[Rules.maxLength(500, '留言不能超過500字')]}>\r
          <Textarea placeholder="請輸入您的留言..." rows={3} />\r
        </FormItem>\r
\r
